...
import demtile from './img/demtile.jpeg';
...
export const articles = [
  ...
  },
  {
    ...
    text: "ブログの方で紹介した修正版の変換式と可視化に基づき、Python (+ NumPy)で変換のための関数を実装した。簡単なテストも実行済。",
  ...
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/2745d36f20ba47d7e53a",
    tag: tags.qiita,
    category: [
      categories.vis
    ],
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/84e1410bd4fdf049857c",
    tag: tags.qiita,
    category: [
      categories.algorithms,
      categories.vis
  ...
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/4be9b9f928724a389a85",
    tag: tags.qiita,
    category: [
      categories.math,
      categories.vis
  ...
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/8f5da8c22d907352e4c9",
    tag: tags.qiita,
    category: [
      categories.math,
      categories.algorithms
  ...
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/0403d8d07e90c62f596b",
    tag: tags.qiita,
    category: [
      categories.algorithms,
      categories.math
  ...
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/998f8387c4f4c84e707b",
    tag: tags.qiita,
    category: [
      categories.vis
    ],
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/1ece810f93d1bd352b5e",
    tag: tags.qiita,
    category: [
      categories.math
    ],
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/edb9340d7e1274baf22a",
    tag: tags.qiita,
    category: [
      categories.algorithms,
      categories.math
  ...
  {
    image: dempython,
    title: "国土地理院の標高タイルをPythonで取得する",
    text: "複数のタイル座標にわたって標高タイルを取得・結合する関数をPythonで実装した。任意の長方形領域を1つの二次元配列として取得できる。",
    link: "https://qiita.com/sw1227/items/877d966da9a5af53b05d",
    tag: tags.qiita,
    category: [
      categories.geospatial
    ],
  ...
  {
    image: demtile,
    title: "国土地理院の標高タイルをJavaScriptで適切に取得する",
    text: "国土地理院の公開している標高タイルをfetchしてパースする実装や、目視確認または緯度経度からの計算によってタイル座標を確認する方法について、簡単に紹介した。",
    link: "https://qiita.com/sw1227/items/a17d424ce8d0cd2302e6",
    tag: tags.qiita,
    category: [
      categories.geospatial
    ],
  },
  {
    ...
    link: "https://qiita.com/sw1227/items/f08cd25364fbaea07792",
    tag: tags.qiita,
    category: [
      categories.vis
    ],
